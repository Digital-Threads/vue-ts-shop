<template>
      ...
      <div class="2xl:container 2xl:mx-auto md:py-5 lg:px-20 md:px-6 p-4">
        <div class="flex items-center justify-between">
          ...
          <div class="lg:w-3/12 flex justify-end items-center space-x-4">
            <a aria-label="Shopping bag" class="hidden md:block focus:outline-none text-gray-800 dark:text-white focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100 p-0.5 relative" href="javascript:void(0)">
              <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <sup  class="absolute -right-1 top-2 bg-amber-300  text-red-600 font-bold ">{{shopItemCount}}</sup>
            </a>
  ...
  const shopItemCount = shopStorage.value.items.length
  </script>
