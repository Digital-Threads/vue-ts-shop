<template>
    <div class="dark:bg-gray-900">
      <div class="2xl:container 2xl:mx-auto md:py-5 lg:px-20 md:px-6 p-4">
        <div class="flex items-center justify-between">
          <div class="lg:w-3/12">
            <div class="w-7/12 hidden lg:flex items-center space-x-3 border-b border-gray-200 pb-2">
              <div>
                <svg class="fill-stroke text-gray-600 dark:text-white" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M19.0004 19.0004L14.6504 14.6504" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </div>
              <input type="text" placeholder="Search for products" class="bg-transparent text-sm text-gray-600 focus:outline-none" />
            </div>
            <button @click="menu=true" aria-label="Open Menu" class="text-gray-800 dark:text-white hidden md:block lg:hidden focus:outline-none focus:ring-2 focus:ring-gray-800 rounded">
              <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 18L4 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M14 12L4 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M18 6L4 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </button>
            <button @click="search=true" aria-label="Search Menu" class="text-gray-800 dark:text-white md:hidden focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100 p-0.5">
              <svg class="fill-stroke" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 17C13.4183 17 17 13.4183 17 9C17 4.58172 13.4183 1 9 1C4.58172 1 1 4.58172 1 9C1 13.4183 4.58172 17 9 17Z" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M18.9984 19.0004L14.6484 14.6504" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </button>
          </div>
          <div class="lg:w-6/12 flex flex-col justify-center items-center space-y-3.5">
            <div aria-label="Luxiwood. Logo" role="img" class="cursor-pointer">
              <svg class="fill-stroke text-gray-800 dark:text-white" width="146" height="26" viewBox="0 0 146 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <div class="hidden lg:block">
              <ul class="flex items-center space-x-10">
                <li>
                  <router-link to="/" class="dark:text-white dark:hover:text-gray-300 text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"> Home</router-link>
                </li>
                <li>
                  <router-link to="/basket" class="dark:text-white dark:hover:text-gray-300 text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline"> Products</router-link>
                </li>
          ...
          <div class="lg:w-3/12 flex justify-end items-center space-x-4">
            <a aria-label="view favourites" class="hidden md:block focus:outline-none text-gray-800 dark:text-white focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100 p-0.5" href="javascript:void(0)">
              <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <a aria-label="Shopping bag" class="hidden md:block focus:outline-none text-gray-800 dark:text-white focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100 p-0.5" href="javascript:void(0)">
              <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M7.5 10.5V11.25C7.5 12.4435 7.97411 13.5881 8.81802 14.432C9.66193 15.2759 10.8065 15.75 12 15.75C13.1935 15.75 14.3381 15.2759 15.182 14.432C16.0259 13.5881 16.5 12.4435 16.5 11.25V10.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </a>
            <button @click="menusm=true" aria-label="open menu" class="text-gray-800 dark:text-white md:hidden focus:outline-none focus:ring-2 focus:ring-gray-800 rounded hover:bg-gray-100 p-0.5">
              <svg class="fill-stroke" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="md-menu" v-if="menu" class="lg:hidden absolute z-10 inset-0 h-screen w-full dark:bg-gray-800 bg-gray-800 bg-opacity-70 dark:bg-opacity-70">
          <div class="relative w-full h-screen">
            <div class="absolute inset-0 w-1/2 bg-white dark:bg-gray-900 p-6 justify-center">
              <div class="flex items-center justify-between border-b pb-4 border-gray-200 dark:border-gray-700">
                <div class="flex items-center space-x-3 mx-2">
                  ...
                  <input type="text" placeholder="Search for products" class="text-sm text-gray-600 dark:text-gray-300 focus:outline-none bg-transparent" />
                </div>
                <button @click="menu=false" aria-label="close menu" class="focus:outline-none focus:ring-2 focus:ring-gray-800">
              ...
              <div class="mt-8">
                <ul class="flex flex-col space-y-8">
                  <li class="flex items-center justify-between">
                    ...
                    <button aria-label="show options" class="fill-stroke text-black dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 6L8 10L4 6" stroke="currentColor" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </button>
                  </li>
                  <li class="flex items-center justify-between">
                    <a href="javascript:void(0)" class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Catalog</a>
                    <button aria-label="show options" class="fill-stroke text-black dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 6L8 10L4 6" stroke="currentColor" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                  ...
                  <li class="flex items-center justify-between">
                    <a href="javascript:void(0)" class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Pages</a>
                    <button aria-label="show options" class="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 fill-stroke text-black dark:text-white">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 6L8 10L4 6" stroke="currentColor" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                    </button>
                  ...
                  <li class="flex items-center justify-between">
                    <a href="javascript:void(0)" class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Blog</a>
                    <button aria-label="show options" class="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 fill-stroke text-black dark:text-white">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 6L8 10L4 6" stroke="currentColor" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
                  ...
                  <li class="flex items-center justify-between">
                    <a href="javascript:void(0)" class="dark:text-white text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Contact us</a>
                    <button aria-label="show options" class="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 fill-stroke text-black dark:text-white">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 6L8 10L4 6" stroke="currentColor" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                      </svg>
        ...
        <!-- Search menu -->
        <div id="mobile-search-menu" v-if="search" class="md:hidden absolute inset-0 z-10 flex flex-col w-full h-screen bg-white dark:bg-gray-900 pt-4">
          <div class="w-full">
            <div class="flex items-center justify-between border-b border-gray-200 pb-3 mx-4">
              <div class="flex items-center space-x-3 mx-2">
                <div>
                  <svg class="fill-stroke text-gray-800 dark:text-white" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 17C13.4183 17 17 13.4183 17 9C17 4.58172 13.4183 1 9 1C4.58172 1 1 4.58172 1 9C1 13.4183 4.58172 17 9 17Z" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <input type="text" placeholder="Search for products" class="text-sm text-gray-600 focus:outline-none bg-transparent" />
              </div>

              <button aria-label="close menu" @click="search=false" class="text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                <svg class="fill-stroke" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="mt-8 mx-4">
            <h2 class="text-sm text-gray-600 dark:text-gray-300 uppercase">Suggestions</h2>
            <ul class="mt-6 flex flex-col space-y-6">
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-sm text-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Bags</a>
              </li>
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-sm text-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Shoes</a>
              </li>
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-sm text-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Capes</a>
              </li>
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-sm text-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Coats</a>
              </li>
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-sm text-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Denim 2021</a>
              </li>
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-sm text-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Leather shoe collection 2021</a>
              </li>
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-sm text-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Active wear</a>
              </li>
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-sm text-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline">Sweat suits</a>
              </li>
            </ul>
          </div>
        ...
        <div id="mobile-menu" v-if="menusm" class="md:hidden absolute inset-0 z-10 flex flex-col w-full h-screen bg-white pt-4">
          <div class="w-full">
            <div class="flex items-center justify-between border-b border-gray-200 pb-4 mx-4">
              <div></div>
              <div><p class="text-base font-semibold text-gray-800">Menu</p></div>
              <button aria-label="close menu" @click="menusm=false" class="text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-gray-800">
                <svg class="fill-stroke" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M15 5L5 15" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M5 5L15 15" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
          ...
          <div class="mt-6 mx-4">
            <ul class="flex flex-col space-y-8">
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-base text-gray-800 focus:outline-none dark:text-white focus:ring-2 focus:ring-gray-800 hover:underline">Home</a>
                <button class="focus:outline-none focus:ring-2 text-black dark:text-white focus:ring-gray-800 rounded hover:bg-gray-100 p-0.5">
              ...
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-base text-gray-800 focus:outline-none dark:text-white focus:ring-2 focus:ring-gray-800 hover:underline">Catalog</a>
                <button class="focus:outline-none focus:ring-2 text-black dark:text-white focus:ring-gray-800 rounded hover:bg-gray-100 p-0.5">
                  <svg class="fill-stroke" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 6L8 10L4 6" stroke="currentColor" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
              ...
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-base text-gray-800 focus:outline-none dark:text-white focus:ring-2 focus:ring-gray-800 hover:underline">Pages</a>
                <button class="focus:outline-none focus:ring-2 text-black dark:text-white focus:ring-gray-800 rounded hover:bg-gray-100 p-0.5">
                  <svg class="fill-stroke" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 6L8 10L4 6" stroke="currentColor" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
              ...
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-base text-gray-800 focus:outline-none dark:text-white focus:ring-2 focus:ring-gray-800 hover:underline">Blog</a>
                <button class="focus:outline-none focus:ring-2 text-black dark:text-white focus:ring-gray-800 rounded hover:bg-gray-100 p-0.5">
                  <svg class="fill-stroke" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 6L8 10L4 6" stroke="currentColor" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
              ...
              <li class="flex items-center justify-between">
                <a href="javascript:void(0)" class="text-base text-gray-800 focus:outline-none dark:text-white focus:ring-2 focus:ring-gray-800 hover:underline">Contact us</a>
                <button class="focus:outline-none focus:ring-2 text-black dark:text-white focus:ring-gray-800 rounded hover:bg-gray-100 p-0.5">
                  <svg class="fill-stroke" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 6L8 10L4 6" stroke="currentColor" stroke-width="0.75" stroke-linecap="round" stroke-linejoin="round" />
                  </svg>
          ...
          <div class="w-full h-full flex items-end">
            <ul class="bg-gray-50 dark:bg-gray-800 py-10 px-4 flex flex-col space-y-8 w-full">
              <li>
                <a class="flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline" href="javascript:void(0)">
                  <div>
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M4.33333 1L1 5V19C1 19.5304 1.23413 20.0391 1.65087 20.4142C2.06762 20.7893 2.63285 21 3.22222 21H18.7778C19.3671 21 19.9324 20.7893 20.3491 20.4142C20.7659 20.0391 21 19.5304 21 19V5L17.6667 1H4.33333Z" stroke="#1F2937" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M1 5H21" stroke="#1F2937" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                      <path d="M15.4436 9C15.4436 10.0609 14.9753 11.0783 14.1418 11.8284C13.3083 12.5786 12.1779 13 10.9991 13C9.82039 13 8.68993 12.5786 7.85643 11.8284C7.02294 11.0783 6.55469 10.0609 6.55469 9" stroke="#1F2937" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                  </div>
                  <p class="text-base text-gray-800">Cart</p>
                </a>
              </li>
              <li>
                <a class="flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-gray-800 hover:underline" href="javascript:void(0)">
                  ...
                  <p class="text-base text-gray-800">Wishlist</p>
                </a>
              </li>
            </ul>
          </div>
